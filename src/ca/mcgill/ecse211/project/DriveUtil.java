...
import static ca.mcgill.ecse211.project.DriveUtil.setSpeed;
import static ca.mcgill.ecse211.project.Main.sleepFor;
import static ca.mcgill.ecse211.project.Resources.*;

/**
 * This class is used to define many of the functions that define the movement of the robot.
 * 
 * @author Ricky
 *
 */
public class DriveUtil {
  ...
  /**
   * Initializes the driving acceleration
   */
   ...
   * @param immediateReturn whether or not to return control immediately
   */
  public static void turnBy(double angle, boolean immediateReturn) {
    setSpeed(ROTATE_SPEED);
    leftMotor.rotate(convertAngle(angle), true);
    rightMotor.rotate(-convertAngle(angle), immediateReturn);
  }
